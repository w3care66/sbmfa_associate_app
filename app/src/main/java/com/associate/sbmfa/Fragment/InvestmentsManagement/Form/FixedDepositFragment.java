...
public class FixedDepositFragment extends Fragment {
    ...
    String token="",relationf="Select Relationship*",plan_code="";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view= inflater.inflate(R.layout.fragment_fixed_deposit, container, false);
        ...
        Tenure.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
              if(position > 0) {
                  ...
                  getMadiriydata(plan_code, depositAmount.getText().toString(), String.valueOf(tenureval), "");
              }
            }
            @Override
            public void onNothingSelected(AdapterView<?> parent) {
    ...
    void formSubmit(String associate_no, String token, String  agent_code,  String member_id, String branch_id,
        ...
        try {
          ...
          //  RequestBody _ssbaccounted = RequestBody.create(MediaType.parse("multipart/form-data"), ssbaccounted.getText().toString());
            ...
            Call<InvestmentSavingAccountPlanResponse> applicationsListResponesCall = RestHandler.getApiService().SUMBIT_FIXED_DEPOSIT_Investment_Register_RESPONES_CALL(_associate_no, _token, _agent_code, _member_id, _branch_id, _form_number, _plan_id, _amount, _first_nominee_name
