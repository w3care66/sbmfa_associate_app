...
public class SamraddhJeevanFragment extends Fragment {
    ...
    TextView tenunre,maturityamount,memberidTv,categorytv,memberidprooftv,agnametv,agnumbertv,agcaretv;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view= inflater.inflate(R.layout.fragment_samraddh_jeevan, container, false);
...
//              }else {
    ...
    private void getMadiriydata(String plan_code,String amount) {
        ...
        Call<MaturityAmountBackMoneyResponse> applicationsListResponesCall = RestHandler.getApiService().Maduirty_Jeevan_Investment_RESPONES_CALL(_member_id,_token,_plan_code,_amount);
...
//                        }
    ...
    void formSubmit(String associate_no, String token, String  agent_code,  String member_id, String branch_id,
        ...
        try {
            if(form_number.equals("")){
                Toast.makeText(getActivity(), "Please enter form number", Toast.LENGTH_SHORT).show();
            } else {
                ...
                Call<InvestmentSavingAccountPlanResponse> applicationsListResponesCall = RestHandler.getApiService().SUMBIT_SAMRADHH_JEEVAN_Investment_Register_RESPONES_CALL(_associate_no, _token, _agent_code, _member_id, _branch_id, _form_number, _plan_id, _amount, _first_nominee_name
