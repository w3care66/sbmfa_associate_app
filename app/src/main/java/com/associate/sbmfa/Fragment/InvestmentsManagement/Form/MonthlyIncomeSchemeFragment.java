...
public class MonthlyIncomeSchemeFragment extends Fragment {
    ...
    final ArrayList<String> TenureArrrid =new ArrayList<>();
    ...
    TextView MaturityAmount,AccountBalance,AccountNumber,InterestRate,memberidprooftv,agnametv,agnumbertv,agcaretv;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view= inflater.inflate(R.layout.fragment_monthly_income_scheme, container, false);
...
//                transaction.commit();
        ...
        ArrayAdapter<String> adapterselectDate2 = new ArrayAdapter<String>(getActivity(), R.layout.spiner_item, ReleationArrr);
        adapterselectDate2.setDropDownViewResource(R.layout.spiner_item);
        Relation.setAdapter(adapterselectDate2);
...
//              }else {
        ...
        Tenure.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                if(position > 0) {
                    tenureval = TenureArrrid.get(position - 1).toString();
...
//                        }
        ...
        applicationsListResponesCall.enqueue(new Callback<TenureResponse>() {
            ...
            public void onResponse(Call<TenureResponse> call, Response<TenureResponse> response) {
                if (response != null) {
                    ...
                    List<com.associate.sbmfa.Fragment.InvestmentsManagement.Resepones.Tenure> getTenure = response.body().getResult().getTenure();
                    for (com.associate.sbmfa.Fragment.InvestmentsManagement.Resepones.Tenure Item : getTenure) {
    ...
    void formSubmit(String associate_no, String token, String  agent_code,  String member_id, String branch_id,
        ...
        try {
            ...
            Call<InvestmentSavingAccountPlanResponse> applicationsListResponesCall = RestHandler.getApiService().SUMBIT_MONTHLY_INCOME_SCHEME_Investment_Register_RESPONES_CALL(_associate_no, _token, _agent_code, _member_id, _branch_id, _form_number, _plan_id, _amount, _first_nominee_name
                    ...
                    _second_nominee_relation, _second_nominee_dob, _second_nominee_age, _second_nominee_gender, _second_nominee_percentage,_tenure,_ssbaccounted
            );
