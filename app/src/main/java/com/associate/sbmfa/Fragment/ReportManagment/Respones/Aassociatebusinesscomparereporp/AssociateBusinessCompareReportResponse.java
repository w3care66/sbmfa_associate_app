...
public class AssociateBusinessCompareReportResponse {
...
@Expose
private AssociateBusinessCompareReportResult result;
...
public AssociateBusinessCompareReportResult getResult() {
return result;
}

public void setResult(AssociateBusinessCompareReportResult result) {
this.result = result;
}
