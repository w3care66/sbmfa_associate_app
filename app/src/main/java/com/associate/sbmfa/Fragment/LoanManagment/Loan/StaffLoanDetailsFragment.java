...
public class StaffLoanDetailsFragment extends Fragment {
    View RootView;
    TextView mTextView2;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        RootView = inflater.inflate(R.layout.fragment_staff_loan_details, container, false);
    ...
    private void getdetails(String member_id, String token, String id) {
        try {
            ...
            RestHandler.getApiService().STAFF_LONE_DETAILS_RESPONSE_CALL(
                    _member_id,
                    _token,
                    _id
...
//
//                                Documents__1 documents1=response.body().getResult().getDetail().getCoApplicant().get(0).getDocuments();
...
//                                mBankUnderTakingDoc.setText(documents1.getUnderTakingDoc().get(0).getPath());
...
//                                mBankSecurity.setText(documents1.getSecurity());
                                    ...
                                    mDocumentIdNumber.setText(documents2.getIdNo());
                                     if(documents2.getUploadFile().size()!=0) {
