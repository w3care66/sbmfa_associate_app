...
public class CollectorAgentRenewalResponse {
...
@Expose
private ResultDailyRenewalCollector result;
...
public ResultDailyRenewalCollector getResult() {
return result;
}

public void setResult(ResultDailyRenewalCollector result) {
this.result = result;
}
