...
public class InvestmentDueReportResponse {
...
@Expose
private InvestmentDueResult result;
...
public InvestmentDueResult getResult() {
return result;
}

public void setResult(InvestmentDueResult result) {
this.result = result;
}
