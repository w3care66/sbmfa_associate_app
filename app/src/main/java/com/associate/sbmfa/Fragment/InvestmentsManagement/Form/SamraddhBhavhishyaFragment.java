...
public class SamraddhBhavhishyaFragment extends Fragment {

    View view;
    private int mYear, mMonth, mDay;
    Spinner Relation,srelation;
    String dobdate,sdobdate;
    TextView dob,age,sdob,sage,Tenure;
    ...
    TextView tenunre,maturityamount,InterestRate,categorytv,memberidprooftv,agnametv,agnumbertv,agcaretv;
    ...
    String savingAmount,ssbaccount,searchagent="";
    Button submit;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        view= inflater.inflate(R.layout.fragment_samraddh_bhavhishya, container, false);
...
//              }else {
        ...
        depositAmount.setOnEditorActionListener(new EditText.OnEditorActionListener() {
            @Override
            public boolean onEditorAction(TextView textView, int i, KeyEvent keyEvent) {
           //   Toast.makeText(getActivity(), plan_code.toString(), Toast.LENGTH_SHORT).show();
    ...
    private void getMadiriydata(String plan_code,String amount) {
        ...
        Call<MaturityAmountBackMoneyResponse> applicationsListResponesCall = RestHandler.getApiService(). Maduirty_Bhavhishya_Investment_RESPONES_CALL(_member_id,_token,_plan_code,_amount);
...
//            RequestBody _tenure = RequestBody.create(MediaType.parse("multipart/form-data"), tenureval);
            Call<InvestmentSavingAccountPlanResponse> applicationsListResponesCall = RestHandler.getApiService().SUMBIT_BHAVHISYA_Investment_Register_RESPONES_CALL(_associate_no, _token, _agent_code, _member_id, _branch_id, _form_number, _plan_id, _amount, _first_nominee_name
                    ...
                    _second_nominee_relation, _second_nominee_dob, _second_nominee_age, _second_nominee_gender, _second_nominee_percentage
            );
