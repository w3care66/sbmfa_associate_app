...
public class MaturityAmountBackMoneyResponse {
...
@Expose
private MaturityResultMoneyBack result;
...
public MaturityResultMoneyBack getResult() {
return result;
}

public void setResult(MaturityResultMoneyBack result) {
this.result = result;
}
