...
public class AssociateBusinessReportResponse {
...
@Expose
private ResultBusinessReport result;
...
public ResultBusinessReport getResult() {
return result;
}

public void setResult(ResultBusinessReport result) {
this.result = result;
}
