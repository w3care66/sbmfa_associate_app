...
public class RenewPlanCommanResponse {
    ...
    @Expose
    private ResultRenewPlanComman result;
    ...
    public ResultRenewPlanComman getResult() {
        return result;
    }

    public void setResult(ResultRenewPlanComman result) {
        this.result = result;
    }
