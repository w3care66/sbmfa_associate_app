...
public class LoanRecoveryDetailsResponse {
...
@Expose
private ResultLoanRecoveryDetails result;
...
public ResultLoanRecoveryDetails getResult() {
return result;
}

public void setResult(ResultLoanRecoveryDetails result) {
this.result = result;
}
