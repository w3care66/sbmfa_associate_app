...
public class MonthlyReportPlanResponse {
...
@Expose
private GetPlaMonthlyResult result;
...
public GetPlaMonthlyResult getResult() {
return result;
}

public void setResult(GetPlaMonthlyResult result) {
this.result = result;
}
