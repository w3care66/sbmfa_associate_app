...
public class MaturityKanyadhanYojanaResponse {
...
@Expose
private MatuirtyKanyanDhyanResult result;
...
public MatuirtyKanyanDhyanResult getResult() {
return result;
}

public void setResult(MatuirtyKanyanDhyanResult result) {
this.result = result;
}
