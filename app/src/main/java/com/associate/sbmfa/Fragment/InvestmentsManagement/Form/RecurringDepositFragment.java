...
public class RecurringDepositFragment extends Fragment {
    ...
    String member_id="",branchStr="",toDateval="",Serachmemberid="";
    HashMap<String ,String > UserDataToken;
    String token="",relationf="Select Relationship*",plan_code="",tenureval="";
    ...
    TextView MaturityAmount,AccountBalance,AccountNumber,categorytv,memberidprooftv,agnametv,agnumbertv,agcaretv;
    EditText nameed,depositAmount;
    ...
    String branch_id="",plan_id="",searchagent="",savingAmount="",ssbaccount="";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view= inflater.inflate(R.layout.fragment_recurring_deposit, container, false);
...
//              }else {
        ...
        Tenure.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(position > 0) {
                    tenureval=tenure.get(position-1).getValue().toString();
        ...
        applicationsListResponesCall.enqueue(new Callback<TenureResponse>() {
            ...
            public void onResponse(Call<TenureResponse> call, Response<TenureResponse> response) {
                if (response != null) {
                   ...
                   tenure =response.body().getResult().getTenure();
                    for (Tenure Item : tenure) {
...
//                        }
    ...
    void formSubmit(String associate_no, String token, String  agent_code,  String member_id, String branch_id,
        ...
        try {
            ...
            Call<InvestmentSavingAccountPlanResponse> applicationsListResponesCall = RestHandler.getApiService().SUMBIT_RECURRING_DEPOSIT_Investment_Register_RESPONES_CALL(_associate_no, _token, _agent_code, _member_id, _branch_id, _form_number, _plan_id, _amount, _first_nominee_name
