...
public class LoanCommsionResponse {
...
@Expose
private InvestmenBrachResult result;
...
public InvestmenBrachResult getResult() {
return result;
}

public void setResult(InvestmenBrachResult result) {
this.result = result;
}
