...
public class RenewAccountDetailResponse {
...
@Expose
private ResultRenewalAccountDatails result;
...
public ResultRenewalAccountDatails getResult() {
return result;
}

public void setResult(ResultRenewalAccountDatails result) {
this.result = result;
}
