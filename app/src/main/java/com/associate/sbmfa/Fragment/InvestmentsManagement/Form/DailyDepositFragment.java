...
public class DailyDepositFragment extends Fragment {
    ...
    String branch_id="", searchagent="",plan_id="";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view= inflater.inflate(R.layout.fragment_daily_deposit, container, false);
...
//              }else {
    ...
    void formSubmit(String associate_no, String token, String  agent_code,  String member_id, String branch_id,
        ...
        try {
            ...
            Call<InvestmentSavingAccountPlanResponse> applicationsListResponesCall = RestHandler.getApiService().SUMBIT_DAILY_DEPOSITE_Investment_Register_RESPONES_CALL(_associate_no, _token, _agent_code, _member_id, _branch_id, _form_number, _plan_code, _amount, _first_nominee_name
