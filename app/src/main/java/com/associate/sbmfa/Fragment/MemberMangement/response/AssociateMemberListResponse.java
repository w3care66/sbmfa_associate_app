...
public class AssociateMemberListResponse {
...
@Expose
private ResultAssociate  resultAssociate;
...
public ResultAssociate getResult() {
return resultAssociate;
}

public void setResult(ResultAssociate result) {
