...
public class FlexRecurringDepositeFragment extends Fragment {
    ...
    EditText percentage,sparcentage,nameed;
    Button addNominne;
   ...
   CheckBox yescheck;
    ...
    String tenureval="";
    TextView AccountBalance,AccountNumber;
    String branch_id="",plan_id="",searchagent="";
    int firstrelation,secondrelation;
    TextView formNo,snameed;
    Button submit;
    List<com.associate.sbmfa.Fragment.InvestmentsManagement.Resepones.Tenure> tenure;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        view= inflater.inflate(R.layout.fragment_flex_recurring_deposite, container, false);
            ...
            public void onResponse(Call<MaturityDetailResponse> call, Response<MaturityDetailResponse> response) {
                if (response!=null){
                    if (response.body().getCode() == 200){
                        ...
                        //AccountBalance.setText(maturityResult.get());
...
//                        }
    ...
    void formSubmit(String associate_no, String token, String  agent_code,  String member_id, String branch_id,
        ...
        try {
            ...
            RequestBody _plan_code = RequestBody.create(MediaType.parse("multipart/form-data"), plan_id);
            RequestBody _amount = RequestBody.create(MediaType.parse("multipart/form-data"), amount);
            ...
            Call<InvestmentSavingAccountPlanResponse> applicationsListResponesCall = RestHandler.getApiService().SUMBIT_FLEXI_RECURRING_Investment_Register_RESPONES_CALL(_associate_no, _token, _agent_code, _member_id, _branch_id, _form_number, _plan_code, _amount, _first_nominee_name
