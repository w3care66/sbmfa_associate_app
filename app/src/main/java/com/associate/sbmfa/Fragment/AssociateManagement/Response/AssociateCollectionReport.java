...
public class AssociateCollectionReport {
...
@Expose
private Asociate_collection_Result result;
...
public Asociate_collection_Result getResult() {
return result;
}

public void setResult(Asociate_collection_Result result) {
this.result = result;
}
