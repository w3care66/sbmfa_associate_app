...
public class SavingAccountInvestmentPlanFormFragment extends Fragment {
   ...
   View view;
    ...
    String Serachmemberid="",searchagent="",branch_id="",plan_id="";
    ...
    TextView formNo,snameed,amount,categorytv,memberidprooftv,agnametv,agnumbertv,agcaretv;
    EditText nameed;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view= inflater.inflate(R.layout.fragment_saving_account_investment_plan_form, container, false);
        ...
        amount=view.findViewById(R.id.editTextTextPersonName3);
        ...
        formNo= view.findViewById(R.id.editTextTextPersonName2);
...
//                        }
    ...
    void formSubmit(String associate_no, String token, String  agent_code,  String member_id, String branch_id,
        ...
        try {
            ...
            Call<InvestmentSavingAccountPlanResponse> applicationsListResponesCall = RestHandler.getApiService().SUMBIT_SAVING_Investment_Register_RESPONES_CALL(_associate_no, _token, _agent_code, _member_id, _branch_id, _form_number, _plan_id, _amount, _first_nominee_name
