...
public class TransactionPlanLedgerResponse {
...
@Expose
private ResultPlanTransDetails result;
...
public ResultPlanTransDetails getResult() {
return result;
}

public void setResult(ResultPlanTransDetails result) {
this.result = result;
}
