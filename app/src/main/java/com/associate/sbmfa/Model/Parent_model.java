...
public class Parent_model {
    ...
    public Parent_model(String id, String name, String progress, String chapter_count, List<Child_model> child_models) {
        this.id = id;
        this.name = name;
    ...
    public List<Child_model> getChild_models() {
        return child_models;
    }

    public void setChild_models(List<Child_model> child_models) {
        this.child_models = child_models;
    }
